      ...
      <form onSubmit={handleSubmit(onSubmit)} className='m-4'>
        ...
        <div className='flex'>
          <div className='flex flex-col mt-2 w-1/2'>
            ...
            <input {...register("qtdPages")} type="text" placeholder='Ex.: 150' className='border  rounded rouded-sm h-8 ml-5 mr-3 sm: pl-1.5 border-[var(--border)]'/>
          </div>
          <div className='flex flex-col mt-2 w-1/2'>
            <label className='ml-1'>Página Atual</label>
            <input {...register("actualPage")} type="text" placeholder='Ex.: 10' className='border  rounded rouded-sm h-8  mr-5 sm: pl-1.5 border-[var(--border)]'/>
          </div>
        </div>
        <div className='flex flex-col mt-2'>
        ...
        <div className='flex'>
          <div className='flex flex-col mt-2 w-1/2'>
            ...
            <select {...register("genrer")} name="" className='border rounded rouded-sm h-8 ml-5 mr-5 pl-1.5 border-[var(--border)]'>
          ...
          <div className='flex flex-col mt-2'>
            ...
            <select {...register("status")} name="" className='border rounded rouded-sm h-8 mr-5 sm: pl-1.5 w-full border-[var(--border)]'>
